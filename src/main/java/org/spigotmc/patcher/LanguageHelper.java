...
public class LanguageHelper {
	...
	static {
		...
		if(!System.getProperty("language", "_").equals("en")) {
			for(LanguageHelper lh : Langs)
				if(System.getProperty("user.language").equalsIgnoreCase(lh.LANG_ID)) {
					instance = lh;
					System.out.println("Computer language is detected! ("+lh.THIS_LANG+")");
					break;
				}
			for(LanguageHelper lh : Langs)
				if(System.getProperty("language", "_").equalsIgnoreCase(lh.LANG_ID)) {
					instance = lh;
					System.out.println("Language set (using forced JVM arguments)! ("+lh.THIS_LANG+")");
					break;
				}
		} else {
	...
	public String INFO_DOWNLOAD = "Download success!\nFile name: <file>\nFile size: <size> byte";
	...
	private LanguageHelper(String LANG_ID, String THIS_LANG, String BUTTON_BROWSE, String BUTTON_PATCH, String BUTTON_PATCHING, String BUTTON_OPEN_SITE,
			 ...
			 String INFO_ERROR, String INFO_NEW_VERSION, String INFO_INCORRECT_INPUT, String INFO_CANNOT_CREATE, String INFO_SUCCESS, String INFO_DOWNLOAD, String TITLE_OPEN_FAILED, 
		...
		this.INFO_DOWNLOAD = INFO_DOWNLOAD;
